(function () {
    ...
    HomeController.$inject = ['UserService', 'FlashService', 'AuthenticationService', '$rootScope', '$scope', '$location'];
    function HomeController(UserService, FlashService, AuthenticationService,  $rootScope, $scope, $location) {
        var vm = this;
